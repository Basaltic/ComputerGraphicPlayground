  ...
  return (
    <div className="flex flex-col gap-2 ml-10">
      ...
      <div className="flex flex-col gap-2">
        <div>
          <h2 className="pb-2 text-3xl font-semibold tracking-tight border-b scroll-m-20 first:mt-0">摄像机</h2>
        </div>
        <div className="flex gap-2">
          <div>
            <h2 className="pb-2 text-2xl font-semibold tracking-tight border-b scroll-m-20 first:mt-0">移动</h2>
          </div>
        ...
        <div className="flex gap-2">
          <div>
            <h2 className="pb-2 text-2xl font-semibold tracking-tight border-b scroll-m-20 first:mt-0">旋转</h2>
          </div>
        ...
        <div className="flex gap-2">
          <div>
            <h2 className="pb-2 text-2xl font-semibold tracking-tight border-b scroll-m-20 first:mt-0">缩放</h2>
          </div>
        ...
        <div>
          <h2 className="pb-2 text-3xl font-semibold tracking-tight border-b scroll-m-20 first:mt-0">物体</h2>
        </div>

        <div>
          <h2 className="pb-2 text-3xl font-semibold tracking-tight border-b scroll-m-20 first:mt-0">其他</h2>
        </div>
        <div className="flex gap-2">
